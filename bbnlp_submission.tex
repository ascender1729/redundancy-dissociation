...
were labeled non-confirmatory at freeze time and are superseded by the frozen gate-3 recomputation. Data
availability: the per-feature arrays and all analysis scripts will be released publicly upon publication;
Appendix~\ref{app:setup} specifies the complete experimental setup.
